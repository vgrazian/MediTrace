...
## Done So Far
- [x] PR-UI-6 merged e deploy avviato (PR #114)- [x] PR-UI-5 merged e deploy avviato (PR #113)- [x] PR-UI-4 merged e deploy avviato (PR #112)- [x] PR-UI-3 merged e deploy avviato (PR #111)1. PR-UI-2 merged (#110) e deploy su gh-pages avviato.
...
1. PR-UI-7: Validazione inline + smart defaults (prossimo)
...
- [x] PR-UI-6 merged e deploy avviato (PR #114)- [x] PR-UI-5 merged e deploy avviato (PR #113)- [x] PR-UI-4 merged e deploy avviato (PR #112)- [x] PR-UI-3 merged e deploy avviato (PR #111)- [x] PR-UI-2 merged e deploy avviato (PR #110)
...
- **PR-UI-7: Validazione inline + smart defaults (prossimo)
