...
const DEMO_HOSTS = [
    { id: '__demo__host-1', codiceInterno: 'OSP-01', nome: 'Mario', cognome: 'Rossi', luogoNascita: 'Roma', dataNascita: '1945-03-12', sesso: 'M', codiceFiscale: 'RSSMRA45C12H501X', patologie: 'Allergia penicillina', roomId: '__demo__residenza-demo', bedId: '__demo__bed-1', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-2', codiceInterno: 'OSP-02', nome: 'Anna', cognome: 'Bianchi', luogoNascita: 'Milano', dataNascita: '1948-07-21', sesso: 'F', codiceFiscale: 'BNCNNA48L61F205X', patologie: 'Ipertensione', roomId: '__demo__residenza-demo', bedId: '__demo__bed-2', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-3', codiceInterno: 'OSP-03', nome: 'Giuseppe', cognome: 'Pini', luogoNascita: 'Napoli', dataNascita: '1942-11-03', sesso: 'M', codiceFiscale: 'PNIGPP42S03F839X', patologie: 'Diabete tipo 2', roomId: '__demo__residenza-demo', bedId: '__demo__bed-3', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-4', codiceInterno: 'OSP-04', nome: 'Laura', cognome: 'Tesi', luogoNascita: 'Torino', dataNascita: '1950-02-14', sesso: 'F', codiceFiscale: 'TSELRU50B54L219X', patologie: 'Artrosi', roomId: '__demo__residenza-demo', bedId: '__demo__bed-4', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-5', codiceInterno: 'OSP-05', nome: 'Elena', cognome: 'Seri', luogoNascita: 'Bologna', dataNascita: '1947-09-18', sesso: 'F', codiceFiscale: 'SRELEN47P58A944X', patologie: 'Cardiopatia ischemica', roomId: '__demo__residenza-demo', bedId: '__demo__bed-5', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-6', codiceInterno: 'OSP-06', nome: 'Paolo', cognome: 'Cerri', luogoNascita: 'Genova', dataNascita: '1944-05-09', sesso: 'M', codiceFiscale: 'CRRPLA44E09D969X', patologie: 'Reflusso gastroesofageo', roomId: '__demo__residenza-demo', bedId: '__demo__bed-6', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-7', codiceInterno: 'OSP-07', nome: 'Vito', cognome: 'Danti', luogoNascita: 'Bari', dataNascita: '1941-01-26', sesso: 'M', codiceFiscale: 'DNTVTI41A26A662X', patologie: 'Diabete controllato', roomId: '__demo__residenza-demo', bedId: '__demo__bed-7', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-8', codiceInterno: 'OSP-08', nome: 'Fatima', cognome: 'Mansouri', luogoNascita: 'Rabat', dataNascita: '1949-10-05', sesso: 'F', codiceFiscale: 'MNSFTM49R45Z330X', patologie: 'Ipertensione', roomId: '__demo__residenza-demo', bedId: '__demo__bed-8', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-9', codiceInterno: 'OSP-09', nome: 'Ahmed', cognome: 'Hassan', luogoNascita: 'Casablanca', dataNascita: '1946-12-30', sesso: 'M', codiceFiscale: 'LIXHMD46T30Z330X', patologie: 'BPCO lieve', roomId: '__demo__residenza-demo', bedId: '__demo__bed-9', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__host-10', codiceInterno: 'OSP-10', nome: 'Sara', cognome: 'Riva', luogoNascita: 'Firenze', dataNascita: '1952-04-11', sesso: 'F', codiceFiscale: 'RVISRA52D51D612X', patologie: 'Dimesso', roomId: '__demo__residenza-demo', bedId: '__demo__bed-10', attivo: false, updatedAt: NOW, deletedAt: NOW, syncStatus: 'pending', _seeded: true },
]

const DEMO_STOCK_BATCHES = [
    { id: '__demo__batch-1', drugId: '__demo__drug-1', nomeCommerciale: 'Tachipirina 500 mg', dosaggio: '500 mg', dosi: 30, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L1001', scadenza: '2027-06-30', quantitaIniziale: 100, quantitaAttuale: 52, sogliaRiordino: 20, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-2', drugId: '__demo__drug-2', nomeCommerciale: 'Moment 200 mg', dosaggio: '200 mg', dosi: 20, residenzaId: '__demo__residenza-demo', forma: 'Compresse rivestite', unitaMisura: 'cpr', lotto: 'L2001', scadenza: '2026-12-31', quantitaIniziale: 60, quantitaAttuale: 5, sogliaRiordino: 15, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-3', drugId: '__demo__drug-3', nomeCommerciale: 'Triatec 5 mg', dosaggio: '5 mg', dosi: 28, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L3001', scadenza: '2027-03-31', quantitaIniziale: 90, quantitaAttuale: 72, sogliaRiordino: 10, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-4', drugId: '__demo__drug-4', nomeCommerciale: 'Glucophage 500 mg', dosaggio: '500 mg', dosi: 60, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L4001', scadenza: '2027-09-30', quantitaIniziale: 120, quantitaAttuale: 80, sogliaRiordino: 20, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-5', drugId: '__demo__drug-5', nomeCommerciale: 'Tavor 1 mg', dosaggio: '1 mg', dosi: 30, residenzaId: '__demo__residenza-demo', forma: 'Compresse sublinguali', unitaMisura: 'cpr', lotto: 'L5001', scadenza: '2026-08-31', quantitaIniziale: 30, quantitaAttuale: 3, sogliaRiordino: 8, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-6', drugId: '__demo__drug-1', nomeCommerciale: 'Paracetamolo TEVA 1000 mg', dosaggio: '1000 mg', dosi: 20, residenzaId: '__demo__residenza-demo', forma: 'Compresse effervescenti', unitaMisura: 'cpr', lotto: 'L1002', scadenza: '2027-01-31', quantitaIniziale: 50, quantitaAttuale: 0, sogliaRiordino: 10, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-7', drugId: '__demo__drug-6', nomeCommerciale: 'Norvasc 5 mg', dosaggio: '5 mg', dosi: 30, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L6001', scadenza: '2027-08-31', quantitaIniziale: 100, quantitaAttuale: 85, sogliaRiordino: 15, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-8', drugId: '__demo__drug-7', nomeCommerciale: 'Lasix 40 mg', dosaggio: '40 mg', dosi: 30, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L7001', scadenza: '2027-05-31', quantitaIniziale: 60, quantitaAttuale: 45, sogliaRiordino: 12, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-9', drugId: '__demo__drug-8', nomeCommerciale: 'Nexium 20 mg', dosaggio: '20 mg', dosi: 28, residenzaId: '__demo__residenza-demo', forma: 'Capsule', unitaMisura: 'cps', lotto: 'L8001', scadenza: '2027-04-30', quantitaIniziale: 80, quantitaAttuale: 60, sogliaRiordino: 18, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-10', drugId: '__demo__drug-9', nomeCommerciale: 'Eutirox 100 mcg', dosaggio: '100 mcg', dosi: 50, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L9001', scadenza: '2027-12-31', quantitaIniziale: 90, quantitaAttuale: 78, sogliaRiordino: 14, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-11', drugId: '__demo__drug-10', nomeCommerciale: 'Tenormin 50 mg', dosaggio: '50 mg', dosi: 28, residenzaId: '__demo__residenza-demo', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L10001', scadenza: '2027-07-31', quantitaIniziale: 70, quantitaAttuale: 52, sogliaRiordino: 16, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
]
