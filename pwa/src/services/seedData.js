...
const DEMO_DRUGS = [
    { id: '__demo__drug-1', principioAttivo: 'Paracetamolo', classeTerapeutica: 'Analgesici / Antipiretici', scortaMinima: 10, fornitore: 'Farmacia Centrale', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-2', principioAttivo: 'Ibuprofene', classeTerapeutica: 'FANS', scortaMinima: 8, fornitore: 'Farmacia Centrale', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-3', principioAttivo: 'Ramipril', classeTerapeutica: 'ACE inibitori', scortaMinima: 6, fornitore: 'Fornitore Salute SpA', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-4', principioAttivo: 'Metformina', classeTerapeutica: 'Antidiabetici orali', scortaMinima: 12, fornitore: 'Fornitore Salute SpA', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-5', principioAttivo: 'Lorazepam', classeTerapeutica: 'Ansiolitici', scortaMinima: 4, fornitore: 'Farmacia Ospedaliera', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-6', principioAttivo: 'Amlodipina', classeTerapeutica: 'Antiipertensivi CA', scortaMinima: 8, fornitore: 'Fornitore Salute SpA', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-7', principioAttivo: 'Furosemide', classeTerapeutica: 'Diuretici', scortaMinima: 5, fornitore: 'Farmacia Centrale', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-8', principioAttivo: 'Omeprazolo', classeTerapeutica: 'Inibitori pompa protonica', scortaMinima: 10, fornitore: 'Fornitore Salute SpA', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-9', principioAttivo: 'Levotiroxina', classeTerapeutica: 'Ormoni tiroidei', scortaMinima: 6, fornitore: 'Farmacia Centrale', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__drug-10', principioAttivo: 'Atenololo', classeTerapeutica: 'Beta bloccanti', scortaMinima: 7, fornitore: 'Fornitore Salute SpA', note: '', updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
]
...
const DEMO_HOSTS = [
    ...
    { id: '__demo__host-2', codiceInterno: 'OSP-02', nome: 'Anna Maria', cognome: 'Cigliano', luogoNascita: 'Milano', dataNascita: '1948-07-21', sesso: 'F', codiceFiscale: 'BNCNNA48L61F205X', patologie: 'Ipertensione', roomId: '__demo__residenza-demo', bedId: '__demo__bed-2', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
...
const DEMO_STOCK_BATCHES = [
    ...
    { id: '__demo__batch-2', drugId: '__demo__drug-2', nomeCommerciale: 'Moment 200 mg', dosaggio: '200 mg', forma: 'Compresse rivestite', unitaMisura: 'cpr', lotto: 'L2001', scadenza: '2026-12-31', quantitaIniziale: 60, quantitaAttuale: 5, sogliaRiordino: 15, updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
    ...
    { id: '__demo__batch-9', drugId: '__demo__drug-8', nomeCommerciale: 'Nexium 20 mg', dosaggio: '20 mg', forma: 'Capsule', unitaMisura: 'cps', lotto: 'L8001', scadenza: '2027-04-30', quantitaIniziale: 80, quantitaAttuale: 60, sogliaRiordino: 18, updatedAt: NOW, deletedAt: null, syncStatus: 'synced', _seeded: true },
...
const DEMO_REMINDERS = [
    { id: '__demo__rem-1', hostId: '__demo__host-1', therapyId: '__demo__therapy-1', drugId: '__demo__drug-1', scheduledAt: buildDateStr(-1, 8, 0), stato: 'ESEGUITO', eseguitoAt: buildDateStr(-1, 8, 12), operatore: 'Oper1', note: '', updatedAt: buildDateStr(-1, 8, 12), deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__rem-2', hostId: '__demo__host-1', therapyId: '__demo__therapy-1', drugId: '__demo__drug-1', scheduledAt: buildDateStr(-1, 20, 0), stato: 'SALTATO', eseguitoAt: buildDateStr(-1, 20, 5), operatore: 'Oper1', note: 'Paziente dormiva', updatedAt: buildDateStr(-1, 20, 5), deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__rem-3', hostId: '__demo__host-2', therapyId: '__demo__therapy-3', drugId: '__demo__drug-2', scheduledAt: buildDateStr(-1, 7, 0), stato: 'ESEGUITO', eseguitoAt: buildDateStr(-1, 7, 8), operatore: 'Oper2', note: '', updatedAt: buildDateStr(-1, 7, 8), deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__rem-4', hostId: '__demo__host-3', therapyId: '__demo__therapy-5', drugId: '__demo__drug-5', scheduledAt: buildDateStr(-1, 21, 0), stato: 'POSTICIPATO', eseguitoAt: null, operatore: 'Oper3', note: 'Rimandato a domani', updatedAt: buildDateStr(-1, 21, 5), deletedAt: null, syncStatus: 'synced', _seeded: true },
    // Oggi — mattina già eseguiti, pomeriggio/sera da eseguire
    { id: '__demo__rem-5', hostId: '__demo__host-1', therapyId: '__demo__therapy-2', drugId: '__demo__drug-3', scheduledAt: buildDateStr(0, 7, 30), stato: 'ESEGUITO', eseguitoAt: buildDateStr(0, 7, 35), operatore: 'Oper1', note: '', updatedAt: buildDateStr(0, 7, 35), deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__rem-6', hostId: '__demo__host-5', therapyId: '__demo__therapy-7', drugId: '__demo__drug-6', scheduledAt: buildDateStr(0, 9, 0), stato: 'ESEGUITO', eseguitoAt: buildDateStr(0, 9, 5), operatore: 'Oper2', note: '', updatedAt: buildDateStr(0, 9, 5), deletedAt: null, syncStatus: 'synced', _seeded: true },
    { id: '__demo__rem-7', hostId: '__demo__host-6', therapyId: '__demo__therapy-9', drugId: '__demo__drug-8', scheduledAt: buildDateStr(0, 8, 0), stato: 'ESEGUITO', eseguitoAt: buildDateStr(0, 8, 10), operatore: 'Oper1', note: '', updatedAt: buildDateStr(0, 8, 10), deletedAt: null, syncStatus: 'synced', _seeded: true },
