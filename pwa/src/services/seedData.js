...
const DEMO_HOSTS = [
    ...
    { id: '__demo__host-2', codiceInterno: 'OSP-02', nome: 'Anna Maria', cognome: 'Cigliano', luogoNascita: 'Milano', dataNascita: '1948-07-21', sesso: 'F', codiceFiscale: 'BNCNNA48L61F205X', patologie: 'Ipertensione', roomId: '__demo__residenza-demo', bedId: '__demo__bed-2', attivo: true, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
...
const DEMO_STOCK_BATCHES = [
    { id: '__demo__batch-1', drugId: '__demo__drug-1', nomeCommerciale: 'Tachipirina 500 mg', dosaggio: '500 mg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L1001', scadenza: '2027-06-30', quantitaIniziale: 100, quantitaAttuale: 52, sogliaRiordino: 20, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-2', drugId: '__demo__drug-2', nomeCommerciale: 'Moment 200 mg', dosaggio: '200 mg', forma: 'Compresse rivestite', unitaMisura: 'cpr', lotto: 'L2001', scadenza: '2026-12-31', quantitaIniziale: 60, quantitaAttuale: 5, sogliaRiordino: 15, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-3', drugId: '__demo__drug-3', nomeCommerciale: 'Triatec 5 mg', dosaggio: '5 mg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L3001', scadenza: '2027-03-31', quantitaIniziale: 90, quantitaAttuale: 72, sogliaRiordino: 10, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-4', drugId: '__demo__drug-4', nomeCommerciale: 'Glucophage 500 mg', dosaggio: '500 mg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L4001', scadenza: '2027-09-30', quantitaIniziale: 120, quantitaAttuale: 80, sogliaRiordino: 20, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-5', drugId: '__demo__drug-5', nomeCommerciale: 'Tavor 1 mg', dosaggio: '1 mg', forma: 'Compresse sublinguali', unitaMisura: 'cpr', lotto: 'L5001', scadenza: '2026-08-31', quantitaIniziale: 30, quantitaAttuale: 3, sogliaRiordino: 8, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-6', drugId: '__demo__drug-1', nomeCommerciale: 'Paracetamolo TEVA 1000 mg', dosaggio: '1000 mg', forma: 'Compresse effervescenti', unitaMisura: 'cpr', lotto: 'L1002', scadenza: '2027-01-31', quantitaIniziale: 50, quantitaAttuale: 0, sogliaRiordino: 10, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-7', drugId: '__demo__drug-6', nomeCommerciale: 'Norvasc 5 mg', dosaggio: '5 mg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L6001', scadenza: '2027-08-31', quantitaIniziale: 100, quantitaAttuale: 85, sogliaRiordino: 15, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-8', drugId: '__demo__drug-7', nomeCommerciale: 'Lasix 40 mg', dosaggio: '40 mg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L7001', scadenza: '2027-05-31', quantitaIniziale: 60, quantitaAttuale: 45, sogliaRiordino: 12, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-9', drugId: '__demo__drug-8', nomeCommerciale: 'Nexium 20 mg', dosaggio: '20 mg', forma: 'Capsule', unitaMisura: 'cps', lotto: 'L8001', scadenza: '2027-04-30', quantitaIniziale: 80, quantitaAttuale: 60, sogliaRiordino: 18, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-10', drugId: '__demo__drug-9', nomeCommerciale: 'Eutirox 100 mcg', dosaggio: '100 mcg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L9001', scadenza: '2027-12-31', quantitaIniziale: 90, quantitaAttuale: 78, sogliaRiordino: 14, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
    { id: '__demo__batch-11', drugId: '__demo__drug-10', nomeCommerciale: 'Tenormin 50 mg', dosaggio: '50 mg', forma: 'Compresse', unitaMisura: 'cpr', lotto: 'L10001', scadenza: '2027-07-31', quantitaIniziale: 70, quantitaAttuale: 52, sogliaRiordino: 16, updatedAt: NOW, deletedAt: null, syncStatus: 'pending', _seeded: true },
]
