...
- Name: router-redirects.spec.js >> route /informazioni redirects to /manuale after authentication
- Location: tests/e2e/router-redirects.spec.js:12:1
