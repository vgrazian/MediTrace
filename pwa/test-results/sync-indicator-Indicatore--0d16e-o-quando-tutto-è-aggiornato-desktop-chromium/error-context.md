...
- Name: sync-indicator.spec.js >> Indicatore stato sincronizzazione >> Mostra "Sincronizzato" quando tutto è aggiornato
- Location: tests/e2e/sync-indicator.spec.js:12:5
...
Call log:
  - waiting for locator('.sync-indicator') to be visible
