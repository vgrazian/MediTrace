...
VITE_AXIOM_TOKEN_VALUE="$(resolve_value "$LOCAL_ENV_FILE" "VITE_AXIOM_TOKEN")"
VITE_AXIOM_EDGE_URL_VALUE="$(resolve_value "$LOCAL_ENV_FILE" "VITE_AXIOM_EDGE_URL")"
VITE_AXIOM_DATASET_VALUE="$(resolve_value "$LOCAL_ENV_FILE" "VITE_AXIOM_DATASET")"
VITE_AXIOM_ENCRYPTION_SALT_VALUE="$(resolve_value "$LOCAL_ENV_FILE" "VITE_AXIOM_ENCRYPTION_SALT")"
VITE_AXIOM_ENCRYPTION_PASSPHRASE_VALUE="$(resolve_value "$LOCAL_ENV_FILE" "VITE_AXIOM_ENCRYPTION_PASSPHRASE")"
...
VITE_AXIOM_TOKEN=${VITE_AXIOM_TOKEN_VALUE}
VITE_AXIOM_EDGE_URL=${VITE_AXIOM_EDGE_URL_VALUE}
VITE_AXIOM_DATASET=${VITE_AXIOM_DATASET_VALUE}
VITE_AXIOM_ENCRYPTION_SALT=${VITE_AXIOM_ENCRYPTION_SALT_VALUE}
VITE_AXIOM_ENCRYPTION_PASSPHRASE=${VITE_AXIOM_ENCRYPTION_PASSPHRASE_VALUE}
EOF
...
if [[ "$SET_GH" == "1" ]]; then
  ...
  set_repo_variable "VITE_AXIOM_EDGE_URL" "$VITE_AXIOM_EDGE_URL_VALUE"
  set_repo_variable "VITE_AXIOM_DATASET" "$VITE_AXIOM_DATASET_VALUE"
  set_repo_variable "VITE_AXIOM_ENCRYPTION_SALT" "$VITE_AXIOM_ENCRYPTION_SALT_VALUE"
  set_repo_secret "VITE_AXIOM_TOKEN" "$VITE_AXIOM_TOKEN_VALUE"
  set_repo_secret "VITE_AXIOM_ENCRYPTION_PASSPHRASE" "$VITE_AXIOM_ENCRYPTION_PASSPHRASE_VALUE"
fi
